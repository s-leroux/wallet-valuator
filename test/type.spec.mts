...
describe("Type utilities", function () {
  describe("Ensure", function () {
    ...
    const test_cases = [
      ...
      ["isOneCharString", null, TypeError],
      ["isOneCharString", "", ValueError],
      ["isOneCharString", "a"],
      ["isOneCharString", " ",],
      ["isOneCharString", "ab", ValueError],
      ["isOneCharString", 123, TypeError],
      ["isOneCharString", 123.456, TypeError],
      ["isOneCharString", {}, TypeError],
      ["isOneCharString", [], TypeError],
      ["isOneCharString", ["abcde"], TypeError],
      ["isOneCharString", ["abcde", "fghij"], TypeError],
      ["isOneCharString", ["abcde", 123], TypeError],
